      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="300">
            <Button size="lg" className="bg-cyan-400 hover:bg-cyan-500 text-slate-900 text-lg px-8 py-4">
      ...
      <section id="contact" className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div data-aos="fade-up">
            ...
            <Button size="lg" className="bg-cyan-400 hover:bg-cyan-500 text-slate-900 text-lg px-8 py-4 mb-8">
              <Calendar className="h-5 w-5 mr-2" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <Button className="bg-cyan-400 hover:bg-cyan-500 text-slate-900 w-full">
